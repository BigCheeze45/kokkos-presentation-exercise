...
/*****************************************************************************
 *
 * Macros are used for the stencil calculations
 *
 *
*****************************************************************************/
#define j1space(ptr,t,i)  (ptr)[ ((t) & 1) * (Nx + 2) +                 \
                                (i) ]
#define stencil(ptr,t,i) j1space(ptr,t,i) =  ( j1space(ptr, t-1, i-1)  +  \
                                             j1space(ptr, t-1, i  )  +  \
                                             j1space(ptr, t-1, i+1) ) / 3
